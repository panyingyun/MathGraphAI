...
TOOL_REGISTRY: Dict[str, ToolSpec] = {
    ...
    "plot_equations": ToolSpec("plot_equations", "write", graph_tools.plot_equations, "用方程列表替换当前图像", PlotEquationsArgs),
    ...
    "set_graph_markers": ToolSpec(
        "set_graph_markers", "write", viewport_tools.set_graph_markers, "写入交点/零点等图标记", SetGraphMarkersArgs
    ),
}
