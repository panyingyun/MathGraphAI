...
export function GraphViewer() {
  ...
  useEffect(() => {
    ...
    const layout = {
      ...
      plot_bgcolor: "#ffffff",
      font: { family: "SF Mono, JetBrains Mono, Menlo, Consolas, monospace", size: 11, color: "#504f49" },
      xaxis: {
        range: [viewport.xMin, viewport.xMax],
        showgrid: settings.showGrid,
        gridcolor: "#ebe6e2",
        zeroline: settings.showAxis,
        zerolinecolor: "#8a857c",
        zerolinewidth: 1.5,
      ...
      legend: { x: 0.02, y: 0.98, bgcolor: "rgba(255,255,255,.86)", bordercolor: "#e7e2dd", borderwidth: 1 },
      hovermode: "closest",
      dragmode: "pan",
